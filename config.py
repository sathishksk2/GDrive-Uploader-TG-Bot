...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1993509398:AAEtxcsV7bm3b6nBoXtfApuwfRK8yAlNPTw' # Get it from https://t.me/BotFather
    APP_ID = '1677067' # Get it from my.telegram.org/apps
    API_HASH = '0d8c8aabe36b01db6a26a7f2780fa660' # Get it from my.telegram.org/apps
